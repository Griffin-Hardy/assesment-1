...
//CODE HERE
const gitDefinition = "git is a tool developers use to to keep track of changes in their code."
...
//CODE HERE
const gitHubDefinition = "github is a website wer developers can upload and store their gits privately of to the public, enabling developers to work together on a single project easily. "
...
//CODE HERE
const gitInitDefinition = "The git init command creates a new git repository, developers can use it to convert an existing git project to a git repository or intitailize a new empty repository"
...
//CODE HERE
const gitPushDefinition = "git push updates a remote repository with commits from your computer"